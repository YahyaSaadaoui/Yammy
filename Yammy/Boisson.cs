...
namespace Yammy
{
    public partial class Boisson : Form
    {
        public Boisson()
        {
            InitializeComponent();
        ...
        private void Boisson_Load(object sender, EventArgs e)
        {
        ...
        public int nombre()
        {
            ...
            macmd.CommandText = "select count(IdB) from Boisson where IdB=@IdB";
            macmd.Parameters.AddWithValue("@IdB", SqlDbType.Int).Value = textBoxN.Text;
        ...
        {
            macmd.Connection = macnx;
            macmd.CommandText = "select IdB [Numero],Nom ,Prix from Boisson";
            SqlDataReader DR = macmd.ExecuteReader();
            DataTable DT = new DataTable();
            DT.Load(DR);
            dataGridViewBoisson.DataSource = DT;
        }
        ...
        private void Ajouter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (nombre() == 0)
                {
                    ...
                    macmd.Connection = macnx;
                    macmd.CommandText = "insert into Boisson values(@IdB,@nom,@prix)";
                    macmd.Parameters.AddWithValue("@IdPB", SqlDbType.Int).Value = textBoxN.Text;
        ...
        private void Supprimer_Click(object sender, EventArgs e)
        {
            if (nombre() != 0)
            {
                macmd.Parameters.Clear();
                macmd.Connection = macnx;
                macmd.CommandText = "Delete from Boisson where IdB=@IdB";
                macmd.Parameters.AddWithValue("@IdB", SqlDbType.Int).Value = textBoxN.Text;
        ...
        private void Modifier_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                macmd.CommandText = "Update Boisson set Nom=@nom ,Prix=@prix  where IdB=@IdB";
                macmd.Parameters.AddWithValue("@IdB", SqlDbType.Int).Value = textBoxN.Text;
                macmd.Parameters.AddWithValue("@nom", SqlDbType.VarChar).Value = textBoxnom.Text;
                macmd.Parameters.AddWithValue("@prix", SqlDbType.VarChar).Value = textBoxprix.Text;
                initialisation(this);
        ...
        private void Rechercher_Click(object sender, EventArgs e)
        {
            macmd.Parameters.Clear();
            macmd.Connection = macnx;
            macmd.CommandText = "select * from Boisson where IdB=@IdB";
            macmd.Parameters.AddWithValue("@IdB", SqlDbType.Int).Value = textBoxN.Text;
            SqlDataReader dr = macmd.ExecuteReader();
            dr.Read();
        ...
        {
            macmd.Connection = macnx;
            macmd = new SqlCommand("select * from Boisson", macnx);
            SqlDataReader dr = macmd.ExecuteReader();
        ...
        private void Précedent_Click(object sender, EventArgs e)
        {
            ...
            {
                macmd.Connection = macnx;
                macmd = new SqlCommand("select * from Boisson where IdB <" + textBoxN.Text + "order by IdB desc", macnx);
        ...
        private void Suivant_Click(object sender, EventArgs e)
        {
            ...
            {
                macmd.Connection = macnx;
                macmd = new SqlCommand("select * from Boisson where IdB >" + textBoxN.Text + "order by IdB asc", macnx);
